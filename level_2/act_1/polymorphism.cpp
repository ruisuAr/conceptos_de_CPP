...
class Persona {
 ...
 public:
  Persona(string, int);
  // se incluye un método que será invocado en diferentes funciones y es en este
  // donde se ve reflejado el polimorfismo del programa.Para incluir
  // polimorfismo se utiliza la palabra reservada del lenguaje virtual, la cual
  // indica que se trata de un método de polimorfismo y únicamente se utiliza en
  // la clase padre
  virtual void ver();
};
