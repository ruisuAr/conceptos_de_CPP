...
Cada camión debe cargar a su máxima capacidad, si la siguiente saca
excede el límite de capacidad el camión debe partir y asi hasta
completar 20 camiones.
*/
...
int main() {
    ...
    for (int i = 1; i <= 20; i++) {
        ...
        // Reiniciar acumulador de sacas para cada camión
        acum_sacas = 0;
    ...
    cout << "Se completo la producción del dia, se despacharon 20 "
            "camiones";
