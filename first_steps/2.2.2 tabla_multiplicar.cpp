...
// Este programa genera una tabla de multiplicación para un número dado hasta un
// límite especificado por el usuario.

#include <iostream>
using namespace std;

void tablaMultiplicacion(
    int n1,
    int n2) {  // n1 es el número a multiplicar, n2 es el límite de la tabla
  for (int i = 1; i <= n2; i++) {
