// Este programa pide al usuario que ingrese 3 nombres, los ordena
// alfabéticamente y los imprime. Compilación: g++ -g sort_names.cpp -o
// sort_names Ejecución: ./sort_names
